...
static int init_finish(adns_state ads) {
  ...
  ads->udpsocket= adns__sock_socket(AF_INET,SOCK_DGRAM,proto->p_proto);
...
#ifdef HAVE_W32_SYSTEM
static void
read_w32_init_files (adns_state ads) {
