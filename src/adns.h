...
void adns_free(void *p);
/* This is a wrapper around free(3); in general there is no need to
 * use it.  However, when using the Windows DLL the use of this
 * wrapper is suggested to avoid problems with mixed C runtime
 * libraries.
 */
